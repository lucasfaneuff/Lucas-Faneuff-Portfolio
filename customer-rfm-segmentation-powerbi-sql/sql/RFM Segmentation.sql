-- save rfm segmentation table for export 
...
CASE
    ...
    WHEN r_score >= 4 AND f_score BETWEEN 2 AND 3 AND m_score BETWEEN 2 AND 4 THEN 'Potential Loyal'
    ...
    WHEN f_score = 5 AND m_score = 5 AND r_score <= 3 THEN 'Est. Spender'
	WHEN m_score = 5 AND f_score <= 3  THEN 'Big Spender'
    WHEN r_score = 2 AND (f_score >= 4 OR m_score >= 4) THEN 'Loyal (At Risk)'
