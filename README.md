...
- Budgeted expenses were not available
- Data is aggregated monthly and does not capture intra-month volatility.
- Results reflect historical performance only and are not predictive.
